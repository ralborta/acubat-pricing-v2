...
console.log('🔍 TEST DUPLICADO - Simulando las DOS validaciones del código de producción...\n');
...
try {
  ...
  // ============================================================================
  // SIMULAR EXACTAMENTE EL FLUJO DE PRODUCCIÓN CON LAS DOS VALIDACIONES
  // ============================================================================
  ...
  openai.chat.completions.create({
    ...
    try {
      ...
      // SIMULAR EXACTAMENTE EL FLUJO DE PRODUCCIÓN CON LAS DOS VALIDACIONES
      // ============================================================================
      console.log('\n🔍 === SIMULANDO FLUJO DE PRODUCCIÓN CON LAS DOS VALIDACIONES ===');
      ...
      // ============================================================================
      // PRIMERA VALIDACIÓN: VALIDACIÓN AGRESIVA (línea 669)
      // ============================================================================
      console.log('\n🔍 === PRIMERA VALIDACIÓN: VALIDACIÓN AGRESIVA (línea 669) ===');
      ...
      console.log('🔧 RESULTADO DESPUÉS DE PRIMERA VALIDACIÓN:', columnMapping);
      
      // ============================================================================
      // SEGUNDA VALIDACIÓN: VALIDACIÓN CRÍTICA (línea 741) - ESTA SOBRESCRIBE LA PRIMERA
      // ============================================================================
      console.log('\n🔍 === SEGUNDA VALIDACIÓN: VALIDACIÓN CRÍTICA (línea 741) - ESTA SOBRESCRIBE LA PRIMERA ===');
